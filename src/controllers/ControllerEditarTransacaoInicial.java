			...
			if (evento.getSource() == botaoVoltar) {
				...
				if (table.getSelectionModel().getSelectedItem() == null) {
					...
					try {
						FXMLLoader fxmlLoader = new FXMLLoader(getClass()
								.getResource(
										"../gui/TelaEditarTransacaoFinal.fxml"));
						Parent root = (Parent) fxmlLoader.load();
						ControllerEditarTransacaoFinal controller = fxmlLoader
								.<ControllerEditarTransacaoFinal> getController();
						controller.inicializa(usuarioAtivo, table
